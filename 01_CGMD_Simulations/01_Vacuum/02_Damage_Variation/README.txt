...
Each subdirectory already includes the initial configuration topology consisting of damaged, unequilibrated surfaces
with counterions distributed in a thin sheet above. Equilibration simulations should be run using LAMMPS:
