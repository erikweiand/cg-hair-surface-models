...
Each subdirectory already includes the initial configuration topology consisting of healthy surfaces
with deposited hemispherical droplets. Simulations should be run using LAMMPS:
